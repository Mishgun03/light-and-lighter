"""
Django settings for LightAndLighter project.
...
WSGI_APPLICATION = 'LightAndLighter.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_SCHEMA_CLASS': 'drf_spectacular.openapi.AutoSchema',   # для openapi
